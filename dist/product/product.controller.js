...
let ProductController = class ProductController {
    ...
    findAll(page, limit, sortBy, order) {
        return this.productService.findAll(parseInt(page, 10) || 1, parseInt(limit, 10) || 10, sortBy || 'name', order || 'asc');
    }
    findOne(id) {
...
__decorate([
    ...
    (0, swagger_1.ApiQuery)({ name: 'sortBy', required: false, enum: ['name', 'price'] }),
